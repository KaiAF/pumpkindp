...
execute as @s[tag=pumpkindb.base,nbt={attack:{}}] on target if entity @s[tag=!dev.mode] run say true0
execute as @s[tag=pumpkindb.base,nbt={attack:{}}] on target if entity @s[tag=!dev.mode] run return fail
execute as @s[tag=pumpkindb.base,nbt={attack:{}}] on target if entity @s[tag=!dev.mode] run say true1
