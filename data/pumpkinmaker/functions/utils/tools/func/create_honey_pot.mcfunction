...
$execute as @s at @s as @e[type=interaction,tag=pumpkindb.honeypot.manager,distance=..0.5,limit=1] unless score @s tempValues matches 0.. run tellraw @a "$(applyNum)"
