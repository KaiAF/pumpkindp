...
# Replace with air
# 1
fill -230 66 -46 -230 66 -46 minecraft:air destroy
fill -230 65 -46 -230 65 -46 minecraft:air destroy
fill -230 64 -46 -230 64 -46 minecraft:air destroy
# 2
fill -236 64 -34 -236 64 -34 minecraft:air destroy
fill -236 63 -34 -236 63 -34 minecraft:air destroy
fill -236 62 -34 -236 62 -34 minecraft:air destroy
# 3
fill -217 64 -43 -217 64 -43 minecraft:air destroy
fill -217 63 -43 -217 63 -43 minecraft:air destroy
fill -217 62 -43 -217 62 -43 minecraft:air destroy
