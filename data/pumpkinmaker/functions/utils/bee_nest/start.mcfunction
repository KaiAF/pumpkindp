...
execute as @s at @s if loaded ~ ~ ~ run schedule function pumpkinmaker:utils/bee_nest/bee_spawn 5t
execute as @s at @s if loaded ~ ~ ~ run schedule function pumpkinmaker:utils/bee_nest/bee_attack 10t
