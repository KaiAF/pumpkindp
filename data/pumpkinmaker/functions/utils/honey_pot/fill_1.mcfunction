...
execute if score @s honey_in_inventory matches 2.. if score @s pot_level matches 1 run setblock 4 66 -38 decorated_pot{sherds: ["minecraft:brewer_pottery_sherd", "minecraft:brewer_pottery_sherd", "minecraft:brewer_pottery_sherd", "minecraft:brewer_pottery_sherd"]} 
execute if score @s honey_in_inventory matches 2.. if score @s pot_level matches 2 run setblock 4 66 -38 decorated_pot{sherds: ["minecraft:danger_pottery_sherd", "minecraft:danger_pottery_sherd", "minecraft:danger_pottery_sherd", "minecraft:danger_pottery_sherd"]} 
execute if score @s honey_in_inventory matches 2.. if score @s pot_level matches 3 run setblock 4 66 -38 decorated_pot{sherds: ["minecraft:howl_pottery_sherd", "minecraft:howl_pottery_sherd", "minecraft:howl_pottery_sherd", "minecraft:howl_pottery_sherd"]} 
