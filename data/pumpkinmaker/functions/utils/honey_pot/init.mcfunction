...
execute as @a run team join player_1 @e[limit=1,team=!player_1]
execute as @a run team join player_2 @e[limit=1,team=!player_2]
execute as @a run team join player_3 @e[limit=1,team=!player_3]
execute as @a run team join player_4 @e[limit=1,team=!player_4]
