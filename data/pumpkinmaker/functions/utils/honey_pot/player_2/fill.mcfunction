...
execute if score @s honey_in_inventory matches 2.. if score @s pot_level matches 0 run setblock 7 66 -31 decorated_pot{sherds: ["blade_pottery_sherd", "blade_pottery_sherd", "blade_pottery_sherd", "blade_pottery_sherd"]} destroy
execute if score @s honey_in_inventory matches 2.. if score @s pot_level matches 1 run setblock 7 66 -31 decorated_pot{sherds: ["brewer_pottery_sherd", "brewer_pottery_sherd", "brewer_pottery_sherd", "brewer_pottery_sherd"]} destroy
execute if score @s honey_in_inventory matches 2.. if score @s pot_level matches 2 run setblock 7 66 -31 decorated_pot{sherds: ["danger_pottery_sherd", "danger_pottery_sherd", "danger_pottery_sherd", "danger_pottery_sherd"]} destroy
execute if score @s honey_in_inventory matches 2.. if score @s pot_level matches 3 run setblock 7 66 -31 decorated_pot{sherds: ["howl_pottery_sherd", "howl_pottery_sherd", "howl_pottery_sherd", "howl_pottery_sherd"]} destroy
