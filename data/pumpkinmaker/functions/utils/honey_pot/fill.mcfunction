...
execute if score @s honey_in_inventory matches 2 run setblock 7 66 -36 decorated_pot{sherds: ["minecraft:blade_pottery_sherd", "minecraft:blade_pottery_sherd", "minecraft:blade_pottery_sherd", "minecraft:blade_pottery_sherd"]} destroy
execute if score @s honey_in_inventory matches 2 run clear @s pointed_dripstone 2
execute if score @s honey_in_inventory matches 3..4 run setblock 7 66 -36 decorated_pot{sherds: ["minecraft:brewer_pottery_sherd", "minecraft:brewer_pottery_sherd", "minecraft:brewer_pottery_sherd", "minecraft:brewer_pottery_sherd"]} destroy
execute if score @s honey_in_inventory matches 3..4 run clear @s pointed_dripstone 4
execute if score @s honey_in_inventory matches 5..6 run setblock 7 66 -36 decorated_pot{sherds: ["minecraft:danger_pottery_sherd", "minecraft:danger_pottery_sherd", "minecraft:danger_pottery_sherd", "minecraft:danger_pottery_sherd"]} destroy
