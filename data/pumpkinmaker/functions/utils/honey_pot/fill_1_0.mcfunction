...
execute if score @s honey_in_inventory matches 2.. if score @s pot_level matches 0 run setblock 7 66 -36 decorated_pot{sherds: ["minecraft:blade_pottery_sherd", "minecraft:blade_pottery_sherd", "minecraft:blade_pottery_sherd", "minecraft:blade_pottery_sherd"]} destroy
