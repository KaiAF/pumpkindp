...
kill @e[type=block_display,x=492,y=65,z=24,limit=1,distance=..3]
kill @e[type=interaction,x=492,y=65,z=24,limit=1,distance=..3]

summon item 492 65 24 {Item:{id:"minecraft:string",Count:3b,tag:{display:{Name:'{"text":"Spider Silk"}'}}}}
