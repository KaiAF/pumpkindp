...
kill @e[type=block_display,x=465,y=65,z=47,limit=1,distance=..3]
kill @e[type=interaction,x=465,y=65,z=47,limit=1,distance=..3]

summon item 465 65 47 {Item:{id:"minecraft:string",Count:3b,tag:{display:{Name:'{"text":"Spider Silk"}'}}}}
