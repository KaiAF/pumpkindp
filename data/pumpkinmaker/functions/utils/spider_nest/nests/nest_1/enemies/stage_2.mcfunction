...
execute if score $countSpiders spider_pos_ran matches 3 run summon spider 259 65 2 {Tags:["nest_1"]}
execute if score $countSpiders spider_pos_ran matches 3 run summon spider 252 65 2 {Tags:["nest_1"]}
