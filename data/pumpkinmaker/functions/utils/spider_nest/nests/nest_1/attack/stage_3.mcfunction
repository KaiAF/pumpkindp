...
kill @e[type=block_display,x=455,y=65,z=0,limit=1,distance=..3]
kill @e[type=interaction,x=455,y=65,z=0,limit=1,distance=..3]

summon item 455 65 0 {Item:{id:"minecraft:string",Count:3b,tag:{display:{Name:'{"text":"Spider Silk"}'}}}}
