...
execute as @s at @s positioned ~ ~1 ~ run summon item_display ~ ~ ~ {Tags: ["nest"], transformation: {translation: [0f, 4f, 0f], scale: [4f, 4f, 4f]}, item:{ id:"minecraft:sniffer_spawn_egg" }}